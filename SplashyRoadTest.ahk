...
AIndex := A_Index
%SplashRef%(Splashy, {mainText: "", subText: "", vHide: 0, instance: A_Index, vPosX: 0, vPosY: spr}*)
} Until (spr > (20 * scrHt/21) - 2 * ahkHt)
...
%SplashRef%(Splashy, {mainText: "", subText: "", vHide: 0, instance: AIndex1, vPosX: spr, vPosY: scrHt - ahkHt}*)
} Until (spr > 20 * scrWd/21)
...
%SplashRef%(Splashy, {mainText: "", subText: "", vHide: 0, instance: AIndex, vPosX: spr1, vPosY: scrHt - spr}*)
...
AIndex1 := AIndex + A_Index
%SplashRef%(Splashy, {mainText: "", subText: "", vHide: 0, instance: AIndex1, vPosX: scrWd - spr, vPosY: 0}*)
} Until (spr > 20 * scrWd/21)
msgbox
...
%SplashRef%(Splashy, {mainText: "", subText: "", vHide: 0, instance: A_Index, vPosX: spr, vPosY: 0}*)
AIndex := A_Index
} Until (spr > 20 * scrWd/21)
...
spr := startPointHt + A_Index * ahkHtAdjust + (A_Index * ahkHtMod)
AIndex1 := AIndex + A_Index
%SplashRef%(Splashy, {mainText: "", subText: "", vHide: 0, instance: AIndex1, vPosX: spr1, vPosY: spr}*)
} Until (spr > (20 * scrHt/21) - 2 * ahkHt)
...
spr := startPointWd + A_Index * ahkWdAdjust + (A_Index * ahkWdMod)
AIndex := AIndex1 + A_Index
%SplashRef%(Splashy, {mainText: "", subText: "", vHide: 0, instance: AIndex, vPosX: scrWd - spr, vPosY: scrHt - ahkHt}*)
} Until (spr > 20 * scrWd/21)
...
spr := startPointHt + A_Index * ahkHtAdjust + ((A_Index + 1) * ahkHtMod)
AIndex1 := AIndex + A_Index
%SplashRef%(Splashy, {mainText: "", subText: "", vHide: 0, instance: AIndex1, vPosX: 0, vPosY: scrHt - spr}*)
} Until (spr > (20 * scrHt/21) - ahkHt)
...
%SplashRef%(Splashy, {mainText: "", subText: "", vHide: 0, instance: A_Index, vPosX: spr, vPosY: 2 * rHt - spr1}*)
...
%SplashRef%(Splashy, {mainText: "", subText: "", vHide: 0, instance: AIndex + A_Index, vPosX: spr, vPosY: 2 * rHt - spr1}*)		
} Until (spr1 <= 0)
msgbox
...
%SplashRef%(Splashy, {mainText: "", subText: "", vHide: 0, instance: A_Index, vPosX: spr, vPosY: spr1}*)
...
spr1 := (AIndex - A_Index - 1) * ahkHtMod
;msgbox % "spr " spr " spr1 " spr1 " triVertLength " triVertLength
%SplashRef%(Splashy, {mainText: "", subText: "", vHide: 0, instance: AIndex + A_Index, vPosX: spr, vPosY: spr1}*)		
} Until (spr1 <= 0)
...
spr := 1
	...
	sleep 100
		...
		%SplashRef%(Splashy, {mainText: "bot", vHide: 0, instance: A_Index, vPosX: (rWd + rWd * ellXArg[A_Index]), vPosY: (rHt + rHt * ellYArg[A_Index])}*)	
		else
		{
			if (A_Index == minIndexTop || (twoTops && A_Index == minIndexTop - 1))
			%SplashRef%(Splashy, {subText: "top", vHide: 0, instance: A_Index, vPosX: (rWd + rWd * ellXArg[A_Index]), vPosY: (rHt + rHt * ellYArg[A_Index])}*)
			else
			%SplashRef%(Splashy, {mainText: "", subText: "", vHide: 0, instance: A_Index, vPosX: (rWd + rWd * ellXArg[A_Index]), vPosY: (rHt + rHt * ellYArg[A_Index])}*)		
		}
	}
...
;msgbox % "minIndexBot " minIndexBot " minIndexTop " minIndexTop " A_Index " A_Index
		if (A_Index == minIndexBot || (twoBots && A_Index == minIndexBot - 1))
		%SplashRef%(Splashy, {mainText: "bot", subText: "", vHide: 0, instance: A_Index}*)	
		else
		{
			if (A_Index == minIndexTop || (twoTops && A_Index == minIndexTop - 1))
			%SplashRef%(Splashy, {mainText: "", subText: "top", vHide: 0, instance: A_Index, vPosX: (rWd + rWd * ellXArg[A_Index]), vPosY: (rHt + rHt * ellYArg[A_Index])}*)
			else
			{
...
AIndex := s
	...
	sleep 100
		...
		%SplashRef%(Splashy, {subText: "top", vHide: 0, instance: AIndex, vPosX: (rWd + rWd * ellXArg[AIndex]), vPosY: (rHt + rHt * ellYArg[AIndex])}*)	
		else
		{
			if (AIndex == minIndexBot || (twoBots && AIndex == minIndexBot - 1))
			%SplashRef%(Splashy, {mainText: "bot", vHide: 0, instance: AIndex, vPosX: (rWd + rWd * ellXArg[AIndex]), vPosY: (rHt + rHt * ellYArg[AIndex])}*)
			else
			%SplashRef%(Splashy, {mainText: "", subText: "", vHide: 0, instance: AIndex, vPosX: (rWd + rWd * ellXArg[AIndex]), vPosY: (rHt + rHt * ellYArg[AIndex])}*)		
		}
...
AIndex := s
	...
	sleep 100
		...
		if (AIndex == minIndexTop || (twoTops && AIndex == minIndexTop - 1))
		%SplashRef%(Splashy, {subText: "top", mainText: "", vHide: 0, instance: AIndex}*)	
		else
		{
			if (AIndex == minIndexBot || (twoBots && AIndex == minIndexBot - 1))
			%SplashRef%(Splashy, {mainText: "bot", subText: "", vHide: 0, instance: AIndex, vPosX: (rWd + rWd * ellXArg[AIndex]), vPosY: (rHt + rHt * ellYArg[AIndex])}*)
			else
			{
