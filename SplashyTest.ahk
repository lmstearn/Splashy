Class Splashy
{
	...
	*/
	...
	splashyInst := "Splashy" . (This.instance)
		...
		Gui, %splashyInst%: New, +OwnDialogs +ToolWindow -Caption +E%WS_EX_COMPOSITED% ;  WS_POPUP active since default
	...
	; critical, else PaintDC gets out of sync
	Sleep, -1
	...
	*/
	...
	DetectHiddenWindows, Off
		...
		Loop %WindowList%
		{
			...
			This.parentClip := spr1 & WS_CLIPCHILDREN
			return spr
			}
		}
	return "Error"
...
GetCtrlType(i)
{
	...
	case 5, 6, 25, 37:
	return 0
	case 4, 6, 15, 16, 21, 33, 26, 27, 38, 39:
	return -1
	Default:
	return 1
	}
